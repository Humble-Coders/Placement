...
import { Plus, Building2, Loader2, AlertCircle, Search, Trash2 } from "lucide-react";
import {
  collection,
  addDoc,
  deleteDoc,
...
export default function CompanyManager({ companies, onRefresh }) {
  ...
  const handleDelete = async (id, name) => {
    if (!window.confirm(`Delete company "${name}"? This won't remove associated questions.`)) return;
    setDeletingId(id);
    try {
